...
//	if(USE_HORIZONTAL==0)LCD_WR_DATA8(&LCD_ctx,LCD_bus,0x00);
//	else if(USE_HORIZONTAL==1)LCD_WR_DATA8(&LCD_ctx,LCD_bus,0xC0);
//	else if(USE_HORIZONTAL==2)LCD_WR_DATA8(&LCD_ctx,LCD_bus,0x70);
//	else LCD_WR_DATA8(&LCD_ctx,LCD_bus,0xA0); 
...
//	while(*s!=0)
//	{
//		if(sizey==12) LCD_ShowChinese12x12(LCD_bus,x,y,s,fc,bc,sizey,mode);
//		else if(sizey==16) LCD_ShowChinese16x16(LCD_bus,x,y,s,fc,bc,sizey,mode);
//		else if(sizey==24) LCD_ShowChinese24x24(LCD_bus,x,y,s,fc,bc,sizey,mode);
//		else if(sizey==32) LCD_ShowChinese32x32(LCD_bus,x,y,s,fc,bc,sizey,mode);
//		else return;
//		s+=2;
//		x+=sizey;
//	}
...
//					if(!mode)//非叠加方式
//					{
//						if(tfont12[k].Msk[i]&(0x01<<j))LCD_WR_DATA(&LCD_ctx,LCD_bus,fc);
//						else LCD_WR_DATA(&LCD_ctx,LCD_bus,bc);
//						m++;
//						if(m%sizey==0)
//						{
//							m=0;
...
//					else//叠加方式
//					{
//						if(tfont12[k].Msk[i]&(0x01<<j))	LCD_DrawPoint(LCD_bus,x,y,fc);//画一个点
//						x++;
//						if((x-x0)==sizey)
//						{
//							x=x0;
...
//					if(!mode)//非叠加方式
//					{
//						if(tfont16[k].Msk[i]&(0x01<<j))LCD_WR_DATA(&LCD_ctx,LCD_bus,fc);
//						else LCD_WR_DATA(&LCD_ctx,LCD_bus,bc);
//						m++;
//						if(m%sizey==0)
//						{
...
//					else//叠加方式
//					{
//						if(tfont16[k].Msk[i]&(0x01<<j))	LCD_DrawPoint(LCD_bus,x,y,fc);//画一个点
//						x++;
//						if((x-x0)==sizey)
//						{
//							x=x0;
...
//					if(!mode)//非叠加方式
//					{
//						if(tfont24[k].Msk[i]&(0x01<<j))LCD_WR_DATA(&LCD_ctx,LCD_bus,fc);
//						else LCD_WR_DATA(&LCD_ctx,LCD_bus,bc);
//						m++;
//						if(m%sizey==0)
//						{
...
//					else//叠加方式
//					{
//						if(tfont24[k].Msk[i]&(0x01<<j))	LCD_DrawPoint(LCD_bus,x,y,fc);//画一个点
//						x++;
//						if((x-x0)==sizey)
//						{
//							x=x0;
...
//					if(!mode)//非叠加方式
//					{
//						if(tfont32[k].Msk[i]&(0x01<<j))LCD_WR_DATA(&LCD_ctx,LCD_bus,fc);
//						else LCD_WR_DATA(&LCD_ctx,LCD_bus,bc);
//						m++;
//						if(m%sizey==0)
//						{
...
//					else//叠加方式
//					{
//						if(tfont32[k].Msk[i]&(0x01<<j))	LCD_DrawPoint(LCD_bus,x,y,fc);//画一个点
//						x++;
//						if((x-x0)==sizey)
//						{
//							x=x0;
...
//			if(!mode)//非叠加模式
//			{
//				if(temp&(0x01<<t))LCD_WR_DATA(&LCD_ctx,LCD_bus,fc);
//				else LCD_WR_DATA(&LCD_ctx,LCD_bus,bc);
//				m++;
//				if(m%sizex==0)
//				{
...
//			else//叠加模式
//			{
//				if(temp&(0x01<<t))LCD_DrawPoint(LCD_bus,x,y,fc);//画一个点
//				x++;
//				if((x-x0)==sizex)
//				{
//					x=x0;
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(RES_GPIO,RES_PIN,RESET);
//	#endif
//}
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(RES_GPIO,RES_PIN,SET);
//	#endif
//}
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(DC_GPIO,DC_PIN,RESET);
//	#endif
//}
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(DC_GPIO,DC_PIN,SET);
//	#endif
//}
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(BLK_GPIO,BLK_PIN,RESET);
//	#endif
//}
...
//{
//	#if defined(STM32F103)
//		HAL_GPIO_WritePin(BLK_GPIO,BLK_PIN,SET);
//	#endif
//}
