...
void RF24L01_Set_Mode(NRF24L01_rtx_t *NRF24L01_rtx , nRf24l01ModeType Mode )
{
    ...
    else 
	{
		...
		{ 
			//controlreg |= ( 1<< PRIM_RX ); 
			 NRF24L01_Write_Reg(NRF24L01_rtx, CONFIG, 0x03 );
		}
	}
...
void RF24L01_Init( NRF24L01_rtx_t *NRF24L01_rtx )
{
    ...
    L01_WriteSingleReg( L01REG_RX_PW_P0, FIXED_PACKET_LEN );	//固定数据长度
     ...
     NRF24L01_Write_Reg(NRF24L01_rtx, CONFIG, /*( 1<<MASK_RX_DR ) |*/		//接收中断
                                      ( 1 << EN_CRC ) |     //使能CRC 1个字节
                                      ( 1 << PWR_UP ) );    //开启设备
    NRF24L01_Write_Reg(NRF24L01_rtx, EN_AA, ( 1 << ENAA_P0 ) );   		//通道0自动应答
    NRF24L01_Write_Reg(NRF24L01_rtx, EN_RXADDR, ( 1 << ERX_P0 ) );		//通道0接收
	NRF24L01_Write_Reg(NRF24L01_rtx, SETUP_RETR, ARD_4000US |
    ...
    NRF24L01_Write_Reg(NRF24L01_rtx, RF_SETUP, 0x0f );
    ...
    NRF24L01_Set_RxAddr(NRF24L01_rtx, 0, &addr[0], 5 );                   //设置RX地址
        ...
        NRF24L01_Write_Reg(NRF24L01_rtx, EN_AA, ( 0 << ENAA_P0 ) );   		//通道0自动应答
    NRF24L01_Write_Reg(NRF24L01_rtx, EN_RXADDR, ( 1 << ERX_P0 ) );		//通道0接收
     NRF24L01_Write_Reg(NRF24L01_rtx, CONFIG,0x0f ); 
       // NRF24L01_Write_Reg(NRF24L01_rtx, SETUP_RETR, 0 );         	//重复等待时间 250us
...
void NRF_Intercommunication(NRF24L01_rtx_t NRF24L01_rtx, NRF24L01_bus_t NRF24L01_bus )
{
  ...
  while (j--)
  {
    RF24L01_Set_Mode(&NRF24L01_rtx, MODE_TX);        // 设置为发送模式
    NRF24L01_TxPacket(&NRF24L01_rtx, &NRF24L01_bus); // 将数据发送出去
    RF24L01_Set_Mode(&NRF24L01_rtx, MODE_RX);        // 将数据发送出去后立马转换成接收模式
    while (RF24L01_Read_IRQ_Status(&NRF24L01_rtx) != 0) // 等待接收成功
    {
    ...
    NRF24L01_TxPacket(&NRF24L01_rtx, &NRF24L01_bus); // 读取接收缓存区数据
    cnt_01 = 0;
    cnt_02 = 0;
  }
}
