...
int main(void)
{
  ...
  {
    NRF24L01_bus.RxPacket.Rxbuffer[i] = 0;
  }
  NRF24L01_bus.RxPacket.Rxlength = 32;
  ...
  //NRF24L01_Set_Power(&NRF24L01_rtx, PWR_12DB);
  ...
  while (1)
  {
    ...
    b = NRF24L01_Read_Reg(&NRF24L01_rtx, NRF_FIFO_STATUS);
